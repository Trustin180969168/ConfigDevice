...
namespace ConfigDevice
{
    ...
    public class ViewLogicAQI : BaseViewLogicControl
    {
        ...
        public override TriggerData GetLogicData()
        {
            ...
            dr.EndEdit();
            TriggerData triggerData = GetInitTriggerData(dr);//----初始化触发数据----
            if (triggerData.TriggerPositionID == SensorConfig.LG_SENSOR_DEV_FLAG
                || triggerData.TriggerPositionID == SensorConfig.LG_SENSOR_DIF_FLAG)//----外设/外设差值---     
        ...
        public override void SetLogicData(TriggerData td)
        {
            ...
            OperateChanged();
            if (td.TriggerPositionID == SensorConfig.LG_SENSOR_DEV_FLAG || 
                td.TriggerPositionID == SensorConfig.LG_SENSOR_DIF_FLAG_VALUE)//--外设/外设差值的情况---               
