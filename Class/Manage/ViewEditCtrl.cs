...
namespace ConfigDevice
{
    ...
    {             
        ...
        public static BaseViewLogicControl GetViewLogicControl(int TriggerID, Device device, GridView gv)
        {
            ...
            if (TriggerID == SensorConfig.LG_SENSOR_DEFAULT)
            ...
            else if (TriggerID == SensorConfig.LG_SENSOR_WIND_DIR)//---风向---
                return new ViewLogicWindyDir(device, gv);
                ...
                TriggerID == SensorConfig.LG_SENSOR_SCIN_3 || TriggerID == SensorConfig.LG_SENSOR_SCIN_4 ||
                TriggerID == SensorConfig.LG_SENSOR_SCIN_5 || TriggerID == SensorConfig.LG_SENSOR_SCIN_6 ||
                TriggerID == SensorConfig.LG_SENSOR_SCIN_7 || TriggerID == SensorConfig.LG_SENSOR_SCIN_8 ||
                TriggerID == SensorConfig.LG_SENSOR_SENONAUTOOFF || TriggerID == SensorConfig.LG_SENSOR_SENONOFF ||
                TriggerID == SensorConfig.LG_SENSOR_KEY1 || TriggerID == SensorConfig.LG_SENSOR_KEY2 ||
                TriggerID == SensorConfig.LG_SENSOR_SAFETYLC || TriggerID == SensorConfig.LG_SENSOR_ALWAYSON ||
                    TriggerID == SensorConfig.LG_SENSOR_CLOSECHECK || TriggerID == SensorConfig.LG_SENSOR_OPENCHECK
                )//---短路输入---
