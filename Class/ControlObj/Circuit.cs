...
namespace ConfigDevice
{
    public class Circuit : ControlObj
    {
        ...
        private void getRoadTitlesData(UdpData data, object[] values)
        {
            ...
            byte byteContrlObj = userData.Data[4];
        ...
        {
            SaveRoadSetting(roadNum,"", roadName);
        }
        public void SaveRoadSetting(int roadNum, string controlObjName, string roadName)
        {
            ...
            UdpData udpSend = createSaveRoadSettingUdp(roadNum, controlObjName, roadName);
        ...
        private UdpData createSaveRoadSettingUdp(int roadNum, string controlObjName, string roadName)
        {
