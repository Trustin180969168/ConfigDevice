...
namespace ConfigDevice
{
    ...
    /// 用于配置按键的控制的类
    /// </summary>
    public class SpecialPanelCtrl : ControlObj
    {
        ...
        public SpecialPanelCtrl(Device device)
            : base(device)
        {
        ...
        private void getKeyOptionData(UdpData data, object[] values)
        {
            ...
            SpecialPanelOptionData option = new SpecialPanelOptionData(userData);
        ...
        /// 保存按键配置
        /// </summary>
        public void SaveKeyOption(SpecialPanelOptionData optionData)
        {
        ...
        private UdpData createSaveOptionUdp(SpecialPanelOptionData optionData)
        {
            UdpData udp = new UdpData();
