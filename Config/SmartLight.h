...
** 修改记录: 
   ...
   (36) V4.9版本, 增加[EQUIPMENT_EL_CUPBOARD]                                      (廖超庭 2017年11月03日)
   (37) V5.0版本, 增加[VIRKEY_TYPE_NULL]等                                         (廖超庭 2018年01月05日)
   (38) V5.1版本, 增加[VIRKEY_TYPE_OUTDOOR][VIRKEY_TYPE_INDOOR]                    (李文委 2018年03月03日)
   (39) V5.2版本, 增加[EQUIPMENT_EL_DOORWINDOW]                                    (李文委 2018年04月13日)
   (40) V5.3版本, 增加[__PRO_VER]协议版本预编译宏定义,为升级协议格式准备           (廖超庭 2018年04月28日)
   (41) V5.4版本, 增加[__DEV_VER]宏定义、增加[EQUIPMENT_CURTAIN_8CH]设备类型       (廖超庭 2018年05月15日)
   (42) V5.5版本, 增加[EQUIPMENT_SKEY_8]设备类型,以此分开区分[专用面板]与[通用面板](廖超庭 2018年05月16日)
**======================================================================================================*/
...
/*======================================================================================================*/
// 2018-04-28 增加
//#define __PRO_VER                     0             //协议格式版本。截止2018-05-15前还是原始版本!!!!!!!!
                                                      //没定义: 原协议格式版本，不支持子系统编号。
                                                      //0:    原协议格式版本，增加支持子系统编号。
#if (defined __PRO_VER) && (__PRO_VER > 0)
#error ""
#endif
...
/*======================================================================================================*/
// 2018-05-15 增加
#define __DEV_VER                       1             //设备类型版本。
                                                      //0/没定义: 增加[EQUIPMENT_EL_DOORWINDOW]以及之前版本
                                                      //1:        增加[EQUIPMENT_CURTAIN_8CH]设备类型
#if (defined __DEV_VER) && (__DEV_VER > 1)
#error ""
#endif
...
#define EQUIPMENT_KEY_1              0x12       //1键按键(通用面板)
#define EQUIPMENT_KEY_2              0x13       //2键按键(通用面板)
#define EQUIPMENT_KEY_3              0x14       //3键按键(通用面板)
#define EQUIPMENT_KEY_4              0x15       //4键按键(通用面板)
#define EQUIPMENT_KEY_5              0x16       //5键按键(通用面板)
#define EQUIPMENT_KEY_6              0x17       //6键按键(通用面板)
#define EQUIPMENT_KEY_7              0x18       //7键按键(通用面板)
#define EQUIPMENT_KEY_8              0x19       //8键按键(通用面板)

#define EQUIPMENT_SKEY_8             0x98       //8键按键(专用面板)
...
#define EQUIPMENT_CURTAIN_2CH        0x4e        //窗帘(电动窗)-2路
#define EQUIPMENT_CURTAIN_3CH        0x4f        //窗帘(电动窗)-3路
#define EQUIPMENT_CURTAIN_8CH        0x86        //窗帘(电动窗)-8路
...
#define EQUIPMENT_EL_DOORWINDOW      0xa5        //电动门窗（磁悬浮门）
...
typedef enum
{
   /*用于新的液晶面板/继电器组/门窗电机等设备 2018-1-6*/
   ...
   VIRKEY_TYPE_OUTDOOR     = 0x53,  //室外门
   VIRKEY_TYPE_INDOOR      = 0x54,  //室内门
