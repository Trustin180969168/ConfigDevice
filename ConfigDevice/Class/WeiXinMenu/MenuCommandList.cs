...
namespace ConfigDevice
{
    public class MenuCommandList
    {
        ...
        public MenuCommandList(Device value)
        {
            this.device = value;
        ...
        /// 获取指令数据
        /// </summary>
        public void ReadCommandData(MenuData menu, int startNum, int endNum)
        {
            menuData = menu;
            UdpData udpSend = createReadCommandsUdp(menu, startNum, endNum);
            callbackGetCommandData.Parameters =new object[]{ menuData.MenuID};//---回调参数----
            getWriteEnd.Parameters[0] = menuData.MenuID;//---回调参数----
            SysCtrl.AddRJ45CallBackList(DeviceConfig.CMD_PUBLIC_WRITE_COMMAND, menuData.MenuID.ToString(), callbackGetCommandData);//---注册回调----
        ...
        public void SaveCommandData(MenuCommandData commandData)
        {
        ...
        public void DelCommandData(int startIndex,int endIndex)
        {
        ...
        public void TestCommands(int Index)
        {
            UdpData udpSend = createTestCommandsUdp(Index);
