...
namespace ConfigDevice
{
    public class CRC32
    {
        ...
        /// 查表法
        /// </summary>
        /// <param name="pData">字节数据</param>
        /// <param name="Length">数据长度</param>
        /// <returns>32位无符号整型</returns>
        public static UInt32 CRC32Software(byte[] pData, short Length)
        {
            ...
            {
                Buffer.BlockCopy(pData, position, p, 0, 4);//----每次复制4个字节---
        ...
        /// 获取校验码
        /// </summary>
        /// <param name="pBuf">字节数据</param>
        /// <param name="nLen">长度</param>
        /// <returns>4位字节</returns>
        public static byte[] GetCheckValue(byte []pBuf)
        {
            short nLen = (short)pBuf.Length;
            System.UInt32 dwCheck = 0;
            if (nLen <= 0 || nLen > 256)
            {
                return null;
            }
            dwCheck = CRC32Software(pBuf, (short)nLen);

            return BitConverter.GetBytes( dwCheck);
        }
